...
import BubbleSortCode from "../../../algorithms/algorithmCode/BubbleSortCode";
import HeapSortCode from "../../../algorithms/algorithmCode/HeapSortCode";
import MergeSortCode from "../../../algorithms/algorithmCode/MergeSortCode";
import InsertionSortCode from "../../../algorithms/algorithmCode/InsertionSortCode";
import QuickSortCode from "../../../algorithms/algorithmCode/QuickSortCode";
import QuickSort3Code from "../../../algorithms/algorithmCode/QuickSort3Code";
import ShellSortCode from "../../../algorithms/algorithmCode/ShellSortCode";
import SelectionSortCode from "../../../algorithms/algorithmCode/SelectionSortCode";
	...
	render() {
		return (
			<div className="SortVisualizer">
				...
				<div>
					{this.props.currAlgorithm === "Bubble Sort" && <BubbleSortCode />}
					{this.props.currAlgorithm === "Heap Sort" && <HeapSortCode />}
					{this.props.currAlgorithm === "Insertion Sort" && (
						<InsertionSortCode />
					)}
					{this.props.currAlgorithm === "Merge Sort" && <MergeSortCode />}
					{this.props.currAlgorithm === "Quick Sort" && <QuickSortCode />}
					{this.props.currAlgorithm === "Quick Sort 3" && <QuickSort3Code />}
					{this.props.currAlgorithm === "Shell Sort" && <ShellSortCode />}
					{this.props.currAlgorithm === "Selection Sort" && (
						<SelectionSortCode />
					)}
				</div>
			</div>
